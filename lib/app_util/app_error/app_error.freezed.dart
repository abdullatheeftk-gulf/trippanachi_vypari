...
class _$AppErrorImpl implements _AppError {
  const _$AppErrorImpl({required this.errorMessage, required this.errorCode});
  ...
  @override
  String toString() {
    return 'AppError(errorMessage: $errorMessage, errorCode: $errorCode)';
  }
...
abstract class _AppError implements AppError {
  const factory _AppError(
      ...
      required final int errorCode}) = _$AppErrorImpl;
