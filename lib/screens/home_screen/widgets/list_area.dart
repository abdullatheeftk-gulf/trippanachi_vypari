                ...
                rows: List.generate(
                  ...
                  (index) => DataRow2(
                    ...
                    cells: [
                      ...
                      DataCell(
                        Text(widget.memberList[index].address ?? "-"),
                      ),
                      DataCell(
                        Text(widget.memberList[index].phoneNumber ?? "-"),
                      ),
                      DataCell(
                        Text(widget.memberList[index].nomineeName ?? "-"),
                      ),
                      DataCell(
                        Text(widget.memberList[index].nomineeRelation ?? "-"),
                      ),
                      DataCell(PopupMenuButton<PopUpMenu>(
                        ...
                        onSelected: (cb) {
                          ...
                          if (cb.name == PopUpMenu.delete.name) {
                            widget.homeCubit
                                .showDeleteDialog(widget.memberList[index]);
                          }
                        },
                        itemBuilder: (context) {
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (_) => const PrintPriviewScreen(),
                ),
              );
            },
            child: const Padding(
