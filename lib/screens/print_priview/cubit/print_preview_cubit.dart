...
class PrintPreviewCubit extends Cubit<PrintPreviewState> {
  ...
  PrintPreviewCubit({required this.printRepository, required this.databaseRepository,}) : super(PrintPreviewInitialState());
  ...
  final members = await databaseRepository.getAllMembers() as List<Member>;
   ...
   return printRepository.generatePdf(pdfPageFormat: pdfPageFormat, title: "പരസ്പര സഹായ നിധി", listOfMember: members) ;
